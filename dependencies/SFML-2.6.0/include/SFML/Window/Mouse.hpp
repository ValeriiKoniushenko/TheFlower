...
/// to the desktop) and one that operates in Window_ coordinates
/// (relative to a specific Window_).
///
/// Usage example:
/// \code
...
///
/// // set mouse position relative to a Window_
/// sf::Mouse::setPosition(sf::Vector2i(100, 200), Window_);
/// \endcode
///
