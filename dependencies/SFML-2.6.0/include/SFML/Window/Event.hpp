...
public:
    ...
    {
        int x; //!< X position of the mouse pointer, relative to the left of the owner Window_
        int y; //!< Y position of the mouse pointer, relative to the top of the owner Window_
    };
    ...
    struct TouchEvent
    {
        ...
        int x;               //!< X position of the touch, relative to the left of the owner Window_
        int y;               //!< Y position of the touch, relative to the top of the owner Window_
    };
    ...
    enum EventType
    {
        Closed,                 //!< The Window_ requested to be closed (no data)
        Resized,                //!< The Window_ was resized (data in event.size)
        LostFocus,              //!< The Window_ lost the focus (no data)
        GainedFocus,            //!< The Window_ gained the focus (no data)
        ...
        MouseEntered,           //!< The mouse cursor entered the area of the Window_ (no data)
        MouseLeft,              //!< The mouse cursor left the area of the Window_ (no data)
...
/// (mouse moved, key pressed, Window_ closed, ...) as well
